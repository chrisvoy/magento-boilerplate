...
class Training_Distributor_Block_Adminhtml_Distributor_Edit_Tab_General
extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Add the form fields
     *
     * @return Training_Distributor_Block_Adminhtml_Distributor_Edit_Tab_General
     */
    protected function _prepareForm()
    {
        ...
        /*
        $fieldset->addType('weight',
            Mage::getConfig()->getBlockClassName('adminhtml/catalog_product_helper_form_weight')
        );
